...
public class ReservationController {
    ...
    public ResponseEntity<GenericResponse<String>> cancilReservation(@PathVariable long id) {
        return ResponseEntity.status(HttpStatus.CREATED).body(GenericResponse.success(reservationRecordService.cancelReservation(id), "Reservation Record Cancel Success ", HttpStatus.CREATED, HttpStatus.CREATED.value()));
    }
